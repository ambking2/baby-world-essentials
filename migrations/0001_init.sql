-- مایگریشن اولیه‌ی دیتابیس جهان کودک روی Cloudflare D1.
--
-- اجرا:
--   npx wrangler d1 migrations apply jahankoodak --local     (توسعه)
--   npx wrangler d1 migrations apply jahankoodak --remote     (تولید)
--
-- این فایل باید همیشه با src/server/schema.ts هم‌خوان بمانَد.
