    ...
    return (
      <StoreShell>
        <div className="container-page py-20 text-center">
          ...
          <Link to="/" className="mt-4 inline-flex rounded-full bg-brand px-5 py-2.5 text-xs font-bold text-primary-foreground">
            بازگشت به فروشگاه
          </Link>
        </div>
      </StoreShell>
  ...
  return (
    <StoreShell>
      <div className="container-page py-8">
        <div className="mb-5 rounded-3xl border border-border bg-brand-soft/50 p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            ...
            <span className="font-bold text-brand">{order.statusLabel}</span>
          </p>
        ...
        <div className="grid gap-5 lg:grid-cols-[1fr_340px]">
          <div className="space-y-5">
            ...
            <section className="rounded-3xl border border-border bg-card p-5 text-xs leading-6">
            ...
            {needsReceipt && card ? (
              <section className="space-y-3 rounded-3xl border border-brand/40 bg-card p-5">
                <h2 className="text-sm font-extrabold">پرداخت کارت‌به‌کارت و ثبت رسید</h2>
                <div className="flex flex-wrap items-center gap-2 rounded-2xl bg-secondary p-4 text-[11px] leading-6">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 rounded-lg border border-border px-2 py-1 text-[11px] hover:border-brand hover:text-brand"
                  >
                  ...
                  <span className="w-full font-bold text-brand">مبلغ قابل واریز: {formatToman(order.grandTotal)}</span>
                </div>
                ...
                >
                  ...
                  <button
                    ...
                    className="rounded-full bg-brand px-5 py-2.5 text-xs font-bold text-primary-foreground disabled:opacity-60 sm:col-span-3"
                  >
          ...
          <aside className="h-fit space-y-2 rounded-3xl border border-border bg-card p-5 text-xs">
            <h2 className="text-sm font-extrabold">صورتحساب</h2>
            ...
            <div className="flex items-center justify-between border-t border-border pt-3">
              ...
              <span className="text-base font-extrabold text-brand">{formatToman(order.grandTotal)}</span>
            </div>
