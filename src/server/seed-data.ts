...
export const PRODUCTS: Array<SeedProduct> = [
  {
    ...
    soldCount: 41,
    images: ["/images/cat-furniture.jpg", "/images/hero-nursery.jpg"],
    attributes: [
  ...
  },
  {
    ...
    madeInWorkshop: true,
    soldCount: 33,
    images: ["/images/cat-dresser.jpg", "/images/workshop.jpg"],
    attributes: [
  ...
  },
  {
    ...
    isFeatured: true,
    soldCount: 58,
    images: ["/images/cat-furniture.jpg"],
    attributes: [
  ...
  },
  {
    ...
    isFeatured: true,
    soldCount: 76,
    images: ["/images/cat-stroller.jpg"],
    attributes: [
  ...
  },
  {
    ...
    isFeatured: true,
    soldCount: 132,
    images: ["/images/cat-clothing.jpg"],
    attributes: [
  ...
  },
  {
    ...
    weightGrams: 500,
    soldCount: 63,
    images: ["/images/hero-nursery.jpg"],
  ...
  },
  {
    ...
    weightGrams: 1_400,
    soldCount: 49,
    images: ["/images/hero-nursery.jpg", "/images/cat-furniture.jpg"],
    attributes: [
...
export const POSTS: Array<SeedPost> = [
  ...
  },
  {
    ...
    cover: "/images/cat-furniture.jpg",
    tag: "ایمنی",
    daysAgo: 9,
  },
  {
